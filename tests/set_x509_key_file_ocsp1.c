...
/* Tests whether setting a single OCSP response to a server with two
 * certificates, is working as expected */
...
void doit(void)
{
	...
	test_cli_serv(xcred, clicred, "NORMAL", "localhost6", NULL, check_response, NULL); /* the DNS name of the first cert */
